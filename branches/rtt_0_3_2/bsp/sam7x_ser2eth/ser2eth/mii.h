...
#define MII_NSR				0x10u		 /* NWay Setup Register RT8201cp*/
#define MII_LBREMR			0x11u	     /* Loopback,Bypass,... RT8201cp*/
#define MII_DCOUNTER        0x12u        /* Disconnect counter          */
#define MII_FCSCOUNTER      0x13u        /* False carrier counter       */
#define MII_NWAYTEST        0x14u        /* N-way auto-neg test reg     */
...
#define MII_DM9161_ID     0x0181b8a0u
#define MII_AM79C875_ID   0x00225540u
#define MII_MICREL_ID     0x00221610u
#define MII_RTL8201_ID    0x82010000u
